...
from .models import admin_dbMongo,RoleMongo,UserMongo
from .views import AdminsViewMongo
admin_db_store= MongoEngineUserDatastore(admin_dbMongo, UserMongo, RoleMongo)
...
class AdminLte(Admin):
    ...
    def __init__(self, app = None, name = None, url = None, subdomain = None, index_view = None,
        ...
        admin_dbMongo.app = app
        admin_dbMongo.init_app(app)
        #Adminstator view
        self.add_view(AdminsViewMongo(UserMongo, name = "Adminstrators", menu_icon_value = 'fa-user-secret'))
